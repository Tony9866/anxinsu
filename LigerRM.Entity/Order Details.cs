		...
		public override void SetValue(string fieldName, object value)
        {
            ...
            { 
				...
				case "ProductID":
                    ...
                    break; 
				case "UnitPrice":
                    this._UnitPrice = DataHelper.ConvertValue<string>(value);
                    break; 
				case "Quantity":
                    this._Quantity = DataHelper.ConvertValue<string>(value);
                    break; 
				case "Discount":
                    this._Discount = DataHelper.ConvertValue<string>(value);
                    break; 
            }
        }
		/// <summary>
