<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HourseQuery.aspx.cs" Inherits="InfoQuery_HourseQuery" %>
...
<body style="padding:10px;height:100%; text-align:center;">
   <input type="hidden" id="MenuNo" value="HourseQuery" />
  ...
  <script type="text/javascript">
      ...
      var grid = $("#maingrid").ligerGrid({
          ...
          url: rootPath + 'handler/grid.ashx?view=v_RentDetail_view', sortName: 'RentNO', rownumbers: true,
              ...
              case "view":
                  ...
                  LG.ajax({
                      ...
                      success: function (data) {
                          wopen('../RentHouse/RentDetail.aspx?RentNo=' + data, '查看房源信息', '800', '600');
                      },
