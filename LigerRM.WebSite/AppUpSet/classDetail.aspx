<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/Detail.master" CodeFile="RentDetail.aspx.cs" Inherits="RentHouse_RentDetail" %>
                ...
                <td align="left">
                        <asp:ValidationSummary ID="ValidationSummary1" runat="server" 
                            ...
                            style="vertical-align:bottom; background-color: #cccccc; margin:5px;">
                                ...
                                <tr id="Tr1" runat="server" visible="false"><td></td><td  colspan="3">
