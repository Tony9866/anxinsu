...
namespace SignetInternet_BusinessLayer
{
    public class Encrypt
    {
        ...
        {
            return DESEncrypt(obj.ToString(), "SGQ&&sgq");
        }
        ...
        public static string DESDecrypt(object obj)
        {
            try
            {
                return DESDecrypt(obj.ToString(), "SGQ&&sgq");
            }
            catch
            {
                return "0";
        ...
        {
            return AESEncode(encryptString.ToString(), MD5("SGQ&&sgq"));
        }
        /// <summary>
        /// AES加密
        /// </summary>
        ...
        {
            return AESDecode(decryptString.ToString(), MD5("SGQ&&sgq"));
        }
        /// <summary>
        /// AES解密
        /// </summary>
