<<<<<<< HEAD
﻿<%@ page language="C#" autoeventwireup="true" inherits="RentHouseReport_RentHouseForPoliceDay, App_Web_axifaauw" %>
=======
<<<<<<< HEAD
﻿<%@ page language="C#" autoeventwireup="true" inherits="RentHouseReport_RentHouseForPoliceDay, App_Web_ywriaorp" %>
=======
﻿<%@ page language="C#" autoeventwireup="true" inherits="RentHouseReport_RentHouseForPoliceDay, App_Web_zdvowk53" %>
    ...
    function toolbarBtnItemClick(item) {
        switch (item.id) {
            case "print":
                ...
                break;
            case "chart":
                top.f_addTab(null, '日统计', "../RentHouseReport/RentLineChart.aspx?type=1&category=" + $("#statistictype").val() + "&year=" + $("#statisticyear").val() + "&month=" + $("#statisticmonth").val() + "&day=" + $("#statisticday").val() + "&psname=" + $("#psname").val());
                break;
            case "Scatt":
