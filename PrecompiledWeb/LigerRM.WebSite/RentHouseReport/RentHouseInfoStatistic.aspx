<<<<<<< HEAD
﻿<%@ page language="C#" autoeventwireup="true" inherits="RentHouseReport_RentHouseInfoStatistic, App_Web_axifaauw" %>
=======
<<<<<<< HEAD
﻿<%@ page language="C#" autoeventwireup="true" inherits="RentHouseReport_RentHouseInfoStatistic, App_Web_ywriaorp" %>
=======
﻿<%@ page language="C#" autoeventwireup="true" inherits="RentHouseReport_RentHouseInfoStatistic, App_Web_zdvowk53" %>
...
<body style="padding:10px;height:100%; text-align:center;">
   <ipnut type="hidden" id="MenuNo" value="HouseInfoStatistic" />
...
//                    { text: '按日统计', id: '2' }
            ...
            { display: "", name: "psname", newline: false, labelWidth: 0, width: 0, space: 0, type: "hidden", cssClass: "field" },
    ...
    var columnStr = [
    {
              ...
              {
              display: "房租姓名", name: "rowner", width: 80, type: "text", align: "left"
          },
          {
          ...
          ,
               { display: "近5天", name: "num13", width: 50, minWidth: 50, type: "text", align: "center",
                   totalSummary:
                    {
                        type: 'sum',
                        render: function (suminf, column, cell) {
               ...
               { display: "近7天", name: "num14", width: 50, minWidth: 50, type: "text", align: "center",
                   totalSummary:
                    {
                        type: 'sum',
                        render: function (suminf, column, cell) {
               ...
               { display: "近30天", name: "num15", width: 50, minWidth: 50, type: "text", align: "center",
                   totalSummary:
                    {
                        type: 'sum',
                        render: function (suminf, column, cell) {
    ...
    var grid = $("#maingrid").ligerGrid({
        ...
        url: rootPath + 'handler/grid.ashx?procedure=up_RentReport_RentHouseStatisticByHouse',
        parms: { where: JSON2.stringify({
            ...
            rules: [{ field: 'statistictype', value: $("[name=statistictype]").val(), type: 'string' },
              ...
              { field: 'psname', value: '全部', type: 'string'},
        ...
        selectRowButtonOnly: true, usePager: false,rownumbers: true
    });
