<<<<<<< HEAD
﻿<%@ page language="C#" autoeventwireup="true" inherits="RentHouseReport_RentPeopleByDateReport, App_Web_axifaauw" %>
=======
<<<<<<< HEAD
﻿<%@ page language="C#" autoeventwireup="true" inherits="RentHouseReport_RentPeopleByDateReport, App_Web_ywriaorp" %>
=======
﻿<%@ page language="C#" autoeventwireup="true" inherits="RentHouseReport_RentPeopleByDateReport, App_Web_zdvowk53" %>
...
<body style="padding:10px;height:100%; text-align:center;">
   <ipnut type="hidden" id="MenuNo" value="AllPoliceStationStatistic" />
...
<script type="text/javascript">
    ...
    $("#formsearch").ligerForm({
        fields: [
          { display: "入住日期", name: "adt_from_date", newline: false, labelWidth: 80, width: 100, space: 20, type: "date", cssClass: "field" },
    ...
    var grid = $("#maingrid").ligerGrid({
        columns: [
          ...
          {
              display: "所属警局", name: "PSName", width: 250, type: "text", align: "left",
              totalSummary:
                    {
                        type: 'sum',
          ...
          {
              display: "入住量", name: "RentRecordCount", width: 80, minWidth: 80, type: "text", align: "left",
              totalSummary:
                    {
                        type: 'sum',
                        render: function (suminf, column, cell) {
        ...
        url: rootPath + 'handler/grid.ashx?procedure=up_RentReport_RentInfoStatisticAllByPoliceStation',
    ...
    function toolbarBtnItemClick(item) {
        switch (item.id) {
            ...
            case "chart":
                ...
                if (type == "全部")
                    type = "";
                top.f_addTab(null, '警局全量统计', "../RentHouseReport/RentColumnChart.aspx?category=AllPoliceStation&sDate=" + $("#adt_from_date").val() + "&eDate=" + $("#adt_to_date").val() + "&psname=" + $("#psname").val());
            ...
            case "pie":
                ...
                if (type == "全部")
                    type = "";
                top.f_addTab(null, '警局全量统计', "../RentHouseReport/RentPieChart.aspx?category=AllPoliceStation&sDate=" + $("#adt_from_date").val() + "&eDate=" + $("#adt_to_date").val() + "&psname=" + $("#psname").val());
                //$.ligerDialog.open({ url: "../chartdrill.aspx?category=CorClass&sDate=" + $("#adt_from_date").val() + "&eDate=" + $("#adt_to_date").val() + "&type=" + type, width: 900, height: 450 }); return;
                break;
        }
    }
