<<<<<<< HEAD
﻿<%@ page language="C#" autoeventwireup="true" inherits="RentHouseReport_RentStatisticForPoliceMonth, App_Web_axifaauw" %>
=======
<<<<<<< HEAD
﻿<%@ page language="C#" autoeventwireup="true" inherits="RentHouseReport_RentStatisticForPoliceMonth, App_Web_ywriaorp" %>
=======
﻿<%@ page language="C#" autoeventwireup="true" inherits="RentHouseReport_RentStatisticForPoliceMonth, App_Web_zdvowk53" %>
...
<script type="text/javascript">
    ...
    $("[name=统计类型]").change(function (value) {
        if ($("[name=statistictype]").val() == '0') {
            parent.f_reloadCurrentTab('../RentHouseReport/RentStatisticForPolice.aspx', '统计');
        }
        if ($("[name=statistictype]").val() == '2') {
            parent.f_reloadCurrentTab('../RentHouseReport/RentStatisticForPoliceDay.aspx', '统计');
        }
    });
    //列表结构
    var columnStr = [ 
    ...
    function toolbarBtnItemClick(item) {
        switch (item.id) {
            case "print":
                ...
                break;
            case "chart":
                top.f_addTab(null, '月度统计', "../RentHouseReport/RentLineChart.aspx?category=" + $("#statistictype").val() + "&year=" + $("#statisticyear").val() + "&month=" + $("#statisticmonth").val() + "&day=" + $("#statisticday").val() + "&psname=" + $("#psname").val());
                break;
            case "Scatt":
