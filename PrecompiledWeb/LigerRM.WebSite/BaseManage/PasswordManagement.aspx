<<<<<<< HEAD
﻿<%@ page language="C#" autoeventwireup="true" inherits="BaseManage_PasswordManagement, App_Web_gnmc3w40" %>
=======
<<<<<<< HEAD
﻿<%@ page language="C#" autoeventwireup="true" inherits="BaseManage_PasswordManagement, App_Web_cc24bspp" %>
=======
﻿<%@ page language="C#" autoeventwireup="true" inherits="BaseManage_PasswordManagement, App_Web_idpc1t1v" %>
  ...
  <script type="text/javascript">
      ...
      var grid = $("#maingrid").ligerGrid({
          columns: [
                ...
                { display: '电子密码', name: 'Password', align: 'left', width: 120, minWidth: 60,
               ...
               { display: "密码类型", name: "", width: 100, type: "text", align: "left",
          ...
          url: '../handler/grid.ashx?view=Rent_Locks_Password_view',
      ...
      grid.bind('afterSubmitEdit', function (e) {
          ...
          LG.ajax({
              loading: '正在保存数据中...',
              type: 'AjaxBaseManage',
              method: isAddNew ? "AddPassword" : "UpdatePassword",
              data: { ID: data.ID, deviceId: lockID, password: data.Password, startdate: data.StartDate.getTime(), enddate: data.EndDate.getTime(), locktype: lockType },
              success: function () {
                  grid.loadData();
                  LG.tip('保存成功!');
              },
